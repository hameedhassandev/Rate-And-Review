...
<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="Index.php">Product Review Analysis for Genuine Rating</a>
...
<div class="container">
    <?php
    if (isset($_GET['productID1'])&&isset($_GET['productID2'])) {
        $prodID1 = $_GET['productID1'];
        $prodID2 = $_GET['productID2'];

        $productView = new ProductView();
        $productView->compare($prodID1,$prodID2);
    }
    ?>
