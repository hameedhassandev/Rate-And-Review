...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input id="password" value="<?= encrypt_decrypt('decrypt', $userInfo['password']); ?>" type="password" name="password" class="form-control"
                 onchange="valid()" onkeyup='valid()'
                       required>
                <div class="input-group-prepend">
...
<script>
    function valid() {
        ...
        if (document.getElementById('password').value.match(password)) {
            ...
            if (document.getElementById('valid_message').innerHTML === 'valid')
